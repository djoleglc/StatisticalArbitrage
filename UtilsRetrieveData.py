...
def moveFile(filename, name, date, diskname):
    """
    ...
    Inputs:
        ...
        -diskname: str
                name of the disk to store the data, e.g. 'H'
           
    """
    shutil.move(filename, f"{diskname}:\\{name}-trades-{date}.zip")

    
def downloadmoveFile(name, date, diskname = "H"):
    """
    ...
    Inputs:
        ...
        -diskname: str
                disk to store the file
    """
    filename = downloadFile(name, date)
    moveFile(filename, name, date, diskname)
